if __name__ == "__main__":
    ...
    dir0jet.cd()
    for k in range(0,nbhist):
      print h_0jet[k].Integral(),hAI_0jet[k].Integral(),h_0jetZTT[k].Integral(),h_0jetZL[k].Integral(),hAI_0jetZTT[k].Integral(),hAI_0jetZL[k].Integral()
