if __name__ == "__main__":
    ...
    for k in range(0,nbhist):
      ...
      print postfix[k],fData.Get("AIboosted1/reweighted_data_obs"+postfix[k]).Integral(),fEmbedded.Get("AIboosted1/reweighted_data_obs"+postfix[k]).Integral(),fVV.Get("AIboosted1/VVT"+postfix[k]).Integral()
