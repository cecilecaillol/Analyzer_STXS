...
file=ROOT.TFile("smh_em_2D.root","r")
file1=ROOT.TFile("smh_em.root","recreate")


file.cd()
dirList = gDirectory.GetListOfKeys()
for k1 in dirList:
      if k1.GetName()=="em_vbf2" or k1.GetName()=="em_gg2jets" or k1.GetName()=="em_vh2jets" or k1.GetName()=="em_1jet":
         h1 = k1.ReadObj()
