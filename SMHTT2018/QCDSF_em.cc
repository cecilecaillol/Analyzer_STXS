...
int main(int argc, char** argv) {
    ...
    else if (sample=="WG") {xs=489.0; weight=luminosity*xs/ngen;}
   ...
   TString postfixMC[63]={"","_CMS_JetEta0to3_2018Down","_CMS_JetEta0to3_2018Up","_CMS_JetEta0to5_2018Down","_CMS_JetEta0to5_2018Up","_CMS_JetEta3to5_2018Down","_CMS_JetEta3to5_2018Up","_CMS_JetRelativeSample_2018Down","_CMS_JetRelativeSample_2018Up","_CMS_JetRelativeBal_2018Down","_CMS_JetRelativeBal_2018Up","_CMS_JetEC2_2018Down","_CMS_JetEC2_2018Up","_CMS_scale_met_unclustered_2018Down","_CMS_scale_met_unclustered_2018Up","_CMS_htt_boson_reso_met_0jet_2018Down","_CMS_htt_boson_reso_met_0jet_2018Up","_CMS_htt_boson_reso_met_1jet_2018Down","_CMS_htt_boson_reso_met_1jet_2018Up","_CMS_htt_boson_reso_met_2jet_2018Down","_CMS_htt_boson_reso_met_2jet_2018Up","_CMS_htt_boson_scale_met_0jet_2018Down","_CMS_htt_boson_scale_met_0jet_2018Up","_CMS_htt_boson_scale_met_1jet_2018Down","_CMS_htt_boson_scale_met_1jet_2018Up","_CMS_htt_boson_scale_met_2jet_2018Down","_CMS_htt_boson_scale_met_2jet_2018Up","_CMS_htt_ttbarShapeDown","_CMS_htt_ttbarShapeUp","_CMS_htt_dyShapeDown","_CMS_htt_dyShapeUp","_CMS_scale_e_2018Down","_CMS_scale_e_2018Up","_CMS_smear_e_2018Down","_CMS_smear_e_2018Up","_CMS_scale_m_etam2p4tom2p1_2018Down","_CMS_scale_m_etam2p4tom2p1_2018Up","_CMS_scale_m_etam2p1tom1p2_2018Down","_CMS_scale_m_etam2p1tom1p2_2018Up","_CMS_scale_m_etam1p2to1p2_2018Down","_CMS_scale_m_etam1p2to1p2_2018Up","_CMS_scale_m_eta1p2to2p1_2018Down","_CMS_scale_m_eta1p2to2p1_2018Up","_CMS_scale_m_eta2p1to2p4_2018Down","_CMS_scale_m_eta2p1to2p4_2018Up","_THU_ggH_MuUp","_THU_ggH_MuDown","_THU_ggH_ResUp","_THU_ggH_ResDown","_THU_ggH_Mig01Up","_THU_ggH_Mig01Down","_THU_ggH_Mig12Up","_THU_ggH_Mig12Down","_THU_ggH_VBF2jUp","_THU_ggH_VBF2jDown","_THU_ggH_VBF3jUp","_THU_ggH_VBF3jDown","_THU_ggH_PT60Up","_THU_ggH_PT60Down","_THU_ggH_PT120Up","_THU_ggH_PT120Down","_THU_ggH_qmtopUp","_THU_ggH_qmtopDown"};

   TString postfixQCD[10]={"_CMS_QCD_njet0_intercept_2018Down","_CMS_QCD_njet0_intercept_2018Up","_CMS_QCD_njet0_slope_2018Down","_CMS_QCD_njet0_slope_2018Up","_CMS_QCD_njet1_intercept_2018Down","_CMS_QCD_njet1_intercept_2018Up","_CMS_QCD_njet1_slope_2018Down","_CMS_QCD_njet1_slope_2018Up","_CMS_QCD_antiiso_2018Down","_CMS_QCD_antiiso_2018Up"};
   ...
   for (Int_t i = 0; i < nentries_wtn; i++) {
	...
	if (mymu.DeltaR(myele)<0.3) continue;
        ...
        /*if (sample=="W"){
            weight=51.54;
            if (numGenJets==1) weight=9.045;
            else if (numGenJets==2) weight=4.493;
            else if (numGenJets==3) weight=3.065;
            else if (numGenJets==4) weight=3.198;
        }
        if (sample=="DY"){
            weight=3.67;
            if (numGenJets==1)
