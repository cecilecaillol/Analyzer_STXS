...
int main(int argc, char** argv) {
   ...
   TFile fw("htt_scalefactors_2017_v4.root");
   ...
   TH1F *h_QCDScaleAcceptance_ZH_lep = (TH1F*) f_QCDScaleAcceptance_VHTT->Get("demo/h_nevents_ZH_lep")->Clone();
...
cout<<lheweight_nominalTo2_average<<" "<<h_QCDScaleAcceptance_ZH_lep->GetBinContent(1)<<" "<<h_QCDScaleAcceptance_ZH_lep->GetBinContent(5)<<" "<<h_QCDScaleAcceptance_ZH_lep->GetBinContent(9)<<endl;
...
lheweight_nominal=1.0;//
	...
	if (do_rivet && !do_differential){
           ...
           if ((name.find("qqH_FWDH_h") < 140 or name.find("WH_FWDH_h") < 140 or name.find("ZH_FWDH_h") < 140 or name.find("VH_FWDH_h") < 140) && Rivet_stage1_1_cat_pTjet30GeV!=200) continue;
	...
	//bool is_ell=(!is_includedInEmbedded && !is_tau && gen_match_1!=6 && gen_match_2!=6);
