...
int main(int argc, char** argv) {
   ...
   else if (is_ggh) nbhist=1+84+18;
   else if (is_qqh) nbhist=1+84+20;
   else if (name=="embedded") nbhist=1+28+23+23;
   else nbhist=1+84+23+23;
   ...
   TFile *f_QCDScaleAcceptance_GGHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/GGHTT2017.root");
   if (sample=="GGZHQQTT125") f_QCDScaleAcceptance_GGHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/GGZHQQTT2017.root");
   ...
   TFile *f_QCDScaleAcceptance_VBFHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/VBFHTT2017.root");
   ...
   TFile *f_QCDScaleAcceptance_VHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/WplusHTT2017.root");
   if (sample=="WminusH125") f_QCDScaleAcceptance_VHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/WminusHTT2017.root");
   if (sample=="ZH125") f_QCDScaleAcceptance_VHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/ZHTT2017.root");
   if (sample=="GGZHLLTT125") f_QCDScaleAcceptance_VHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/GGZHLLTT2017.root");
   if (sample=="GGZHNNTT125") f_QCDScaleAcceptance_VHTT = new TFile("/afs/cern.ch/work/c/ccaillol/public/QCDScaleAcceptance/GGZHNNTT2017.root");
...
lheweight_nominal=1.0;//
	...
	if (sample!="embedded" && sample!="data_obs" && (gen_match_2==1 or gen_match_2==3)){
	   if (fabs(eta_2)<1.46) aweight=aweight*1.22;
           if (fabs(eta_2)>1.558) aweight=aweight*0.93;
	}
	...
	// Top pT reweighting
        ...
        if (sample!="embedded" && sample!="data_obs"){
          ...
          if (trigger27 or trigger32) aweight=aweight*wmc->function("e_trg_ic_ratio")->getVal();
          else{
             float tautrgsf=wmc->function("t_trg_pog_deeptau_medium_etau_ratio")->getVal();
             aweight=aweight*wmc->function("e_trg_24_ic_ratio")->getVal()*tautrgsf;
	   ...
	   massJets=mjj;
           ...
           if (sample!="data_obs" && sample!="embedded"){
              ...
              if (k>66 && k<69){
                ...
                if (k==73 && gen_match_2<5 && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=0.90;}
                else if (k==74 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=1.10;}
                else if (k==75 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=0.90;}
                else if (k==76 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=1.10;}
                else if (k==77 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50) {weight2=0.90;}
                else if (k==78 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50) {weight2=1.10;}
              ...
              else if (k>82 && k<85){ // muR muF scale x 2
                if (k==83) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==84) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
              }
              else if (is_ggh && k>84 && k<103){ // WG1 x 18
                if (k==85) weight2=1+WG1unc[0];
                else if (k==86) weight2=1-WG1unc[0];
                else if (k==87) weight2=1+WG1unc[1];
                else if (k==88) weight2=1-WG1unc[1];
                else if (k==89) weight2=1+WG1unc[2];
                else if (k==90) weight2=1-WG1unc[2];
                else if (k==91) weight2=1+WG1unc[3];
                else if (k==92) weight2=1-WG1unc[3];
                else if (k==93) weight2=1+WG1unc[4];
                else if (k==94) weight2=1-WG1unc[4];
                else if (k==95) weight2=1+WG1unc[5];
                else if (k==96) weight2=1-WG1unc[5];
                else if (k==97) weight2=1+WG1unc[6];
                else if (k==98) weight2=1-WG1unc[6];
                else if (k==99) weight2=1+WG1unc[7];
                else if (k==100) weight2=1-WG1unc[7];
                else if (k==101) weight2=1+WG1unc[8];
                else if (k==102) weight2=1-WG1unc[8];
              }
              else if (is_qqh && k>84 && k<105){ // WG1 x 20
                if (k==85) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==86) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==87) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==88) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==89) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==90) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==91) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==92) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==93) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==94) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==95) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==96) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==97) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==98) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==99) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==100) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==101) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==102) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==103) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==104) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
              }
           ...
           if (name=="ST" or name=="VV" or name=="DY" or sample=="Z" or name=="TT"){
              if (k>84 && k<131){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, myrawele.Pt(), myrawmet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1-84]);
              }
           }
           if (sample=="data_obs"){
              if (k>0 && k<47){ // FF 
           ...
           if (sample=="embedded"){
              if (k>28 && k<75){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, myrawele.Pt(), myrawmet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-28-1]);
              }
           }
    ...
    for (int k=0; k<nbhist; ++k){
       ...
       else if (sample!="data_obs" and name!="embedded" and !is_ggh and !is_qqh and k>84) postfix=postfixFF[k-84];
       else if (is_ggh and k>84) postfix=postfixGGH[k-84];
       else if (is_qqh and k>84) postfix=postfixVBF[k-84];
