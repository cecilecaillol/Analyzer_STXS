...
lheweight_nominal=1.0;//
	...
	if (do_rivet && !do_differential){
           if (name.find("H_FWDH_h") < 140 && Rivet_stage1_1_cat_pTjet30GeV!=100) continue;
           ...
           if (name.find("ggH_PTH_450_650_h") < 140 && (Rivet_stage1_1_cat_pTjet30GeV!=101 or (Rivet_higgsPt<450 or Rivet_higgsPt>650))) continue;
           if (name.find("ggH_PTH_GE650_h") < 140 && (Rivet_stage1_1_cat_pTjet30GeV!=101 or Rivet_higgsPt<650)) continue;
	...
	if (myele.DeltaR(mytau)<0.5) continue;
        ...
        if ((name.find("125")>100 && sample!="data_obs" && sample!="embedded") && gen_match_1>2 && gen_match_1<6 && gen_match_2>2 && gen_match_2<6) is_includedInEmbedded=true; // remove overlap with embedded samples //FIXME
	...
	//recompute fractions //FIXME
        if (njets==0 && myele.DeltaR(mytau)>3){
        ...
        else if (njets==0 && myele.DeltaR(mytau)<=3){
	...
	for (int k=0; k<nbhist; ++k){
	   ...
	   massJets=mjj;
		...
		if (k==65) {weight2=prefiring_weight_down/(prefiring_weight+0.00000001);}
              ...
              if (k>66 && k<77){
                if (k==67 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=0.90;}
                else if (k==68 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=1.10;}
                else if (k==69 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=0.90;}
                else if (k==70 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=1.10;}
                else if (k==71 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50) {weight2=0.90;}
                else if (k==72 && (gen_match_2==1 or gen_match_2==3) && mytau.Pt()>=50) {weight2=1.10;}
	      ...
	      if (k>76 && k<79){ //lhe x 2
                if (k==77) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==78) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
	      }
              else if (is_ggh && k>78 && k<97){ // WG1 x 18
                if (k==79) weight2=1+WG1unc[0];
                else if (k==80) weight2=1-WG1unc[0];
                else if (k==81) weight2=1+WG1unc[1];
                else if (k==82) weight2=1-WG1unc[1];
                else if (k==83) weight2=1+WG1unc[2];
                else if (k==84) weight2=1-WG1unc[2];
                else if (k==85) weight2=1+WG1unc[3];
                else if (k==86) weight2=1-WG1unc[3];
                else if (k==87) weight2=1+WG1unc[4];
                else if (k==88) weight2=1-WG1unc[4];
                else if (k==89) weight2=1+WG1unc[5];
                else if (k==90) weight2=1-WG1unc[5];
                else if (k==91) weight2=1+WG1unc[6];
                else if (k==92) weight2=1-WG1unc[6];
                else if (k==93) weight2=1+WG1unc[7];
                else if (k==94) weight2=1-WG1unc[7];
                else if (k==95) weight2=1+WG1unc[8];
                else if (k==96) weight2=1-WG1unc[8];
             }
              else if (is_qqh && k>78 && k<99){ // WG1 x 20
                if (k==79) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==80) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==81) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==82) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==83) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==84) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==85) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==86) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==87) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==88) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==89) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==90) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==91) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==92) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==93) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==94) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==95) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==96) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==97) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==98) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
              }
           ...
           if (name=="ST" or name=="VV" or name=="DY" or name=="Z" or name=="TT"){
              if (k>78 && k<121){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawelept, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1-78]);
              }
           }
           if (sample=="data_obs"){
              if (k>0 && k<47){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawelept, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1]);
              }
           }
           if (sample=="embedded"){
              if (k>24 && k<71){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawelept, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-24-1]);
              }
           }
    ...
    for (int k=0; k<nbhist; ++k){
       ...
       else if (is_ggh and k>78) postfix=postfixGGH[k-78];
       else if (is_qqh and k>78) postfix=postfixVBF[k-78];
