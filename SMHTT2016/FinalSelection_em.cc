...
int main(int argc, char** argv) {
   ...
   int nbhist=1;
   if (sample=="data_obs" or sample=="embedded") nbhist=1+26;
   else{
      nbhist=1+58+26;
      if (is_ggh) nbhist=1+58+18;
      if (is_qqh) nbhist=1+58+20;
   }
   if (sample=="embedded") nbhist=nbhist+16;
...
lheweight_nominal=1.0;//
	...
	bool is_ell=(!is_includedInEmbedded && !is_tau);//
        //bool is_ell=(!is_includedInEmbedded && !is_tau && gen_match_2!=6 && gen_match_1!=6);
	...
	for (int k=0; k<nbhist; ++k){
	   ...
	   massJets=mjj;
		...
		if (k==49) {weight2=prefiring_weight_down/(prefiring_weight+0.000000001);}
	      ...
	      else if (k>56 && k<59){ //lhe x 2
                if (k==57) weight2=lheweight_nominalTo0p5_average*(lheweight_muR0p5_muF0p5/lheweight_nominal);
                else if (k==58) weight2=lheweight_nominalTo2_average*(lheweight_muR2_muF2/lheweight_nominal);
	      }
              else if (is_ggh && k>58 && k<77){ // WG1 x 18
                if (k==59) weight2=1+WG1unc[0];
                else if (k==60) weight2=1-WG1unc[0];
                else if (k==61) weight2=1+WG1unc[1];
                else if (k==62) weight2=1-WG1unc[1];
                else if (k==63) weight2=1+WG1unc[2];
                else if (k==64) weight2=1-WG1unc[2];
                else if (k==65) weight2=1+WG1unc[3];
                else if (k==66) weight2=1-WG1unc[3];
                else if (k==67) weight2=1+WG1unc[4];
                else if (k==68) weight2=1-WG1unc[4];
                else if (k==69) weight2=1+WG1unc[5];
                else if (k==70) weight2=1-WG1unc[5];
                else if (k==71) weight2=1+WG1unc[6];
                else if (k==72) weight2=1-WG1unc[6];
                else if (k==73) weight2=1+WG1unc[7];
                else if (k==74) weight2=1-WG1unc[7];
                else if (k==75) weight2=1+WG1unc[8];
                else if (k==76) weight2=1-WG1unc[8];
              }
              else if (is_qqh && k>58 && k<79){ // WG1 x 20
		if (k==59) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==60) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==61) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==62) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==63) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==64) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==65) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==66) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==67) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==68) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==69) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==70) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==71) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==72) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==73) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==74) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==75) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==76) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==77) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==78) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
	      }
           }
	   ...
	   if (do_control_plots==1){
	      ...
	      mass6=metcov00;
           ...
           if (sample!="embedded" && !is_ggh && !is_qqh && sample!="data_obs" && k>58 && k<85){ // QCD x 14
                ...
                else if (k==63 && numberJets==1) ssweight=osss_1jet_unc1_down->Eval(myele.DeltaR(mymu));
                else if (k==64 && numberJets==1) ssweight=osss_1jet_unc1_up->Eval(myele.DeltaR(mymu));
                else if (k==65 && numberJets==1) ssweight=osss_1jet_unc2_down->Eval(myele.DeltaR(mymu));
                else if (k==66 && numberJets==1) ssweight=osss_1jet_unc2_up->Eval(myele.DeltaR(mymu));
                else if (k==67 && numberJets>1) ssweight=osss_2jet_unc1_down->Eval(myele.DeltaR(mymu));
                else if (k==68 && numberJets>1) ssweight=osss_2jet_unc1_up->Eval(myele.DeltaR(mymu));
                else if (k==69 && numberJets>1) ssweight=osss_2jet_unc2_down->Eval(myele.DeltaR(mymu));
                else if (k==70 && numberJets>1) ssweight=osss_2jet_unc2_up->Eval(myele.DeltaR(mymu));
                else if (k==71) sscorr=1.0;
                else if (k==72) sscorr=(1+2*(correction->GetBinContent(correction->GetXaxis()->FindBin(mupt),correction->GetYaxis()->FindBin(ept))-1));
                ...
                else if (k==74 and myele.Pt()>=15 and myele.Pt()<25 and mymu.Pt()>=15 and mymu.Pt()<25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(20.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(20.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(20.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(20.0)),2));
                else if (k==75 and myele.Pt()>=15 and myele.Pt()<25 and mymu.Pt()>=25) weight2=1-sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(20.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(20.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(20.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(20.0)),2));
                else if (k==76 and myele.Pt()>=15 and myele.Pt()<25 and mymu.Pt()>=25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(20.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(20.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(20.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(20.0)),2));
                else if (k==77 and myele.Pt()>=25 and myele.Pt()<35 and mymu.Pt()>=15 and mymu.Pt()<25) weight2=1-sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(30.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(30.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(30.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(30.0)),2));
                else if (k==78 and myele.Pt()>=25 and myele.Pt()<35 and mymu.Pt()>=15 and mymu.Pt()<25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(30.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(30.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(30.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(30.0)),2));
                else if (k==79 and myele.Pt()>=25 and myele.Pt()<35 and mymu.Pt()>=25) weight2=1-sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(30.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(30.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(30.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(30.0)),2));
                else if (k==80 and myele.Pt()>=25 and myele.Pt()<35 and mymu.Pt()>=25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(30.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(30.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(30.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(30.0)),2));
                else if (k==81 and myele.Pt()>=35 and mymu.Pt()>=15 and mymu.Pt()<25) weight2=1-sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(50.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(50.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(50.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(50.0)),2));
                else if (k==82 and myele.Pt()>=35 and mymu.Pt()>=15 and mymu.Pt()<25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(50.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(20.0),closureOS->GetYaxis()->FindBin(50.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(50.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(20.0),correction->GetYaxis()->FindBin(50.0)),2));
                else if (k==83 and myele.Pt()>=35 and mymu.Pt()>=25) weight2=1-sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(50.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(50.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(50.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(50.0)),2));
                else if (k==84 and myele.Pt()>=35 and mymu.Pt()>=25) weight2=1+sqrt(pow(closureOS->GetBinError(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(50.0))/closureOS->GetBinContent(closureOS->GetXaxis()->FindBin(50.0),closureOS->GetYaxis()->FindBin(50.0)),2)+pow(correction->GetBinError(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(50.0))/correction->GetBinContent(correction->GetXaxis()->FindBin(50.0),correction->GetYaxis()->FindBin(50.0)),2));
           }
...
float frac=hfrac_0jetlow->GetBinContent(hfrac_0jetlow->GetXaxis()->FindBin(m_sv));
if (njets==0 && myele.DeltaR(mymu)>2.0 && myele.DeltaR(mymu)<3.0) hfrac_0jethigh->GetBinContent(hfrac_0jethigh->GetXaxis()->FindBin(m_sv));
else if (njets==1) frac=hfrac_boosted1->GetBinContent(hfrac_boosted1->GetXaxis()->FindBin(m_sv));
else if (njets>1 && mjj<350) frac=hfrac_boosted2->GetBinContent(hfrac_boosted2->GetXaxis()->FindBin(m_sv));
else if (njets>1 && mjj>350 && (myele+mymu+mymet).Pt()<200) frac=hfrac_vbflow->GetBinContent(hfrac_vbflow->GetXaxis()->FindBin(m_sv));
else if (njets>1 && mjj>350 && (myele+mymu+mymet).Pt()>200) frac=hfrac_vbfhigh->GetBinContent(hfrac_vbfhigh->GetXaxis()->FindBin(m_sv));
...
//if (category_3 && k==0 && signalRegion && m_sv>250 && m_sv<290) cout<<myele.DeltaR(mymu)<<" "<<myele.Pt()<<" "<<mymu.Pt()<<endl; 
    ...
    for (int k=0; k<nbhist; ++k){
       ...
       else if (!is_ggh && !is_qqh && k>58) postfix=postfixQCD[k-58-1];
       else if (is_ggh && k>58) postfix=postfixGGH[k-58-1];
       else if (is_qqh && k>58) postfix=postfixVBF[k-58-1];
