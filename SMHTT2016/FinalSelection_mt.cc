...
int main(int argc, char** argv) {
    ...
    ofstream list_boosted1;
    list_boosted1.open ("list_boosted1.txt");
   ...
   if (name=="data_obs" or name=="embedded" or name=="ST" or name=="TT" or name=="DY" or name=="Z" or name=="VV") nbhist=nbhist+23+23;//add FF
   ...
   // differential
   /*float bins_mjj[] = {0,45,80,120,200,350,10000}; // 2 jets low mjj, binned in pth
   float bins_mjj_low[] = {0,45,80,120,200,350,600,10000}; // rien
   float bins_mjj_high[] = {0,45,80,120,200,350,600,10000}; // rien
   float bins_pth[] = {0,20,45,80,120,200,350,10000}; // 1 jet, binned in pth
   float bins_pth_1[] = {0,45,80,120,200,350,10000}; // 3 jets, high mjj, binned in pth
   float bins_pth_2[] = {0,150,300,450,600,1000,1400,1800,10000}; // >= 2 jets, binned in mjj
   float bins_taupt[] = {0,45,80,10000}; // 0 jet, binned in pth
   float bins_taupt_low[] = {0,45,80,120,200,350,10000}; // 2 jets, high mjj, binned in pth
   float bins_taupt_high[] = {0,45,80,120,200,350,10000}; // 3 jets, low mjj, binned in pth*/
   ...
   TH1F* f5real=new TH1F ("f5real","f5real",binnum_frac,bins_frac); f5real->Sumw2();
   TH1F* f5jet=new TH1F ("f5jet","f5jet",binnum_frac,bins_frac); f5jet->Sumw2();
   TH1F* f6real=new TH1F ("f6real","f6real",binnum_frac,bins_frac); f6real->Sumw2();
   TH1F* f6jet=new TH1F ("f6jet","f6jet",binnum_frac,bins_frac); f6jet->Sumw2();
   TH1F* f7real=new TH1F ("f7real","f7real",binnum_frac,bins_frac); f7real->Sumw2();
   TH1F* f7jet=new TH1F ("f7jet","f7jet",binnum_frac,bins_frac); f7jet->Sumw2();
   TH1F* f8real=new TH1F ("f8real","f8real",binnum_frac,bins_frac); f8real->Sumw2();
   TH1F* f8jet=new TH1F ("f8jet","f8jet",binnum_frac,bins_frac); f8jet->Sumw2();
   ...
   TString postfixMC[89]={"","_CMS_scale_t_1prongDown","_CMS_scale_t_1prongUp","_CMS_scale_t_1prong1pizeroDown","_CMS_scale_t_1prong1pizeroUp","_CMS_scale_t_3prongDown","_CMS_scale_t_3prongUp","_CMS_scale_t_3prong1pizeroDown","_CMS_scale_t_3prong1pizeroUp","_CMS_tauideff_pt30to35Down","_CMS_tauideff_pt30to35Up","_CMS_tauideff_pt35to40Down","_CMS_tauideff_pt35to40Up","_CMS_tauideff_ptgt40Down","_CMS_tauideff_ptgt40Up","_CMS_JetAbsoluteDown","_CMS_JetAbsoluteUp","_CMS_JetAbsolute_2016Down","_CMS_JetAbsolute_2016Up","_CMS_JetBBEC1Down","_CMS_JetBBEC1Up","_CMS_JetBBEC1_2016Down","_CMS_JetBBEC1_2016Up","_CMS_JetEC2Down","_CMS_JetEC2Up","_CMS_JetEC2_2016Down","_CMS_JetEC2_2016Up","_CMS_JetFlavorQCDDown","_CMS_JetFlavorQCDUp","_CMS_JetHFDown","_CMS_JetHFUp","_CMS_JetHF_2016Down","_CMS_JetHF_2016Up","_CMS_JetRelativeBalDown","_CMS_JetRelativeBalUp","_CMS_JERDown","_CMS_JERUp","_CMS_ZLShape_mt_1prongDown","_CMS_ZLShape_mt_1prongUp","_CMS_ZLShape_mt_1prong1pizeroDown","_CMS_ZLShape_mt_1prong1pizeroUp","_CMS_scale_met_unclusteredDown","_CMS_scale_met_unclusteredUp","_CMS_htt_boson_reso_met_0jetDown","_CMS_htt_boson_reso_met_0jetUp","_CMS_htt_boson_scale_met_0jetDown","_CMS_htt_boson_scale_met_0jetUp","_CMS_htt_boson_reso_met_1jetDown","_CMS_htt_boson_reso_met_1jetUp","_CMS_htt_boson_scale_met_1jetDown","_CMS_htt_boson_scale_met_1jetUp","_CMS_htt_boson_reso_met_2jetDown","_CMS_htt_boson_reso_met_2jetUp","_CMS_htt_boson_scale_met_2jetDown","_CMS_htt_boson_scale_met_2jetUp","_CMS_htt_ttbarShapeDown","_CMS_htt_ttbarShapeUp","_CMS_htt_dyShapeDown","_CMS_htt_dyShapeUp","_CMS_scale_m_etalt1p2Down","_CMS_scale_m_etalt1p2Up","_CMS_scale_m_eta1p2to2p1Down","_CMS_scale_m_eta1p2to2p1Up","_CMS_prefiringDown","_CMS_prefiringUp","_CMS_m_FakeTau_etalt0p4Down","_CMS_m_FakeTau_etalt0p4Up","_CMS_m_FakeTau_eta0p4to0p8Down","_CMS_m_FakeTau_eta0p4to0p8Up","_CMS_m_FakeTau_eta0p8to1p2Down","_CMS_m_FakeTau_eta0p8to1p2Up","_CMS_m_FakeTau_eta1p2to1p7Down","_CMS_m_FakeTau_eta1p2to1p7Up","_CMS_m_FakeTau_etagt1p7Down","_CMS_m_FakeTau_etagt1p7Up","_CMS_m_FakeTau_taupt30to40Down","_CMS_m_FakeTau_taupt30to40Up","_CMS_m_FakeTau_taupt40to50Down","_CMS_m_FakeTau_taupt40to50Up","_CMS_m_FakeTau_tauptgt50Down","_CMS_m_FakeTau_tauptgt50Up","_CMS_etauFR_barrelDown","_CMS_etauFR_barrelUp","_CMS_etauFR_endcapDown","_CMS_etauFR_endcapUp","_CMS_singlemutrgDown","_CMS_singlemutrgUp","_CMS_mutautrgDown","_CMS_mutautrgUp"};
   ...
   TString postfixFF[47]={"","_CMS_rawFF_mt_qcd_0jet_unc1Up","_CMS_rawFF_mt_qcd_0jet_unc2Up","_CMS_rawFF_mt_qcd_0jet_unc1Down","_CMS_rawFF_mt_qcd_0jet_unc2Down","_CMS_rawFF_mt_qcd_1jet_unc1Up","_CMS_rawFF_mt_qcd_1jet_unc2Up","_CMS_rawFF_mt_qcd_1jet_unc1Down","_CMS_rawFF_mt_qcd_1jet_unc2Down","_CMS_rawFF_mt_qcd_2jet_unc1Up","_CMS_rawFF_mt_qcd_2jet_unc2Up","_CMS_rawFF_mt_qcd_2jet_unc1Down","_CMS_rawFF_mt_qcd_2jet_unc2Down","_CMS_rawFF_mt_w_0jet_unc1Up","_CMS_rawFF_mt_w_0jet_unc2Up","_CMS_rawFF_mt_w_0jet_unc1Down","_CMS_rawFF_mt_w_0jet_unc2Down","_CMS_rawFF_mt_w_1jet_unc1Up","_CMS_rawFF_mt_w_1jet_unc2Up","_CMS_rawFF_mt_w_1jet_unc1Down","_CMS_rawFF_mt_w_1jet_unc2Down","_CMS_rawFF_mt_w_2jet_unc1Up","_CMS_rawFF_mt_w_2jet_unc2Up","_CMS_rawFF_mt_w_2jet_unc1Down","_CMS_rawFF_mt_w_2jet_unc2Down","_CMS_rawFF_mt_tt_unc1Up","_CMS_rawFF_mt_tt_unc2Up","_CMS_rawFF_mt_tt_unc1Down","_CMS_rawFF_mt_tt_unc2Down","_CMS_FF_closure_lpt_mt_qcdUp","_CMS_FF_closure_lpt_mt_qcdDown","_CMS_FF_closure_lpt_xtrg_mt_qcdUp","_CMS_FF_closure_lpt_xtrg_mt_qcdDown","_CMS_FF_closure_lpt_mt_wUp","_CMS_FF_closure_lpt_mt_wDown","_CMS_FF_closure_lpt_xtrg_mt_wUp","_CMS_FF_closure_lpt_xtrg_mt_wDown","_CMS_FF_closure_lpt_mt_ttUp","_CMS_FF_closure_lpt_mt_ttDown","_CMS_FF_closure_lpt_xtrg_mt_ttUp","_CMS_FF_closure_lpt_xtrg_mt_ttDown","_CMS_FF_closure_OSSS_mvis_mt_qcdUp","_CMS_FF_closure_OSSS_mvis_mt_qcdDown","_CMS_FF_closure_mt_mt_w_unc1Up","_CMS_FF_closure_mt_mt_w_unc1Down","_CMS_FF_closure_mt_mt_w_unc2Up","_CMS_FF_closure_mt_mt_w_unc2Down"};


   TString postfixEmbedded[29]={"","_CMS_scale_emb_t_1prongDown","_CMS_scale_emb_t_1prongUp","_CMS_scale_emb_t_1prong1pizeroDown","_CMS_scale_emb_t_1prong1pizeroUp","_CMS_scale_emb_t_3prongDown","_CMS_scale_emb_t_3prongUp","_CMS_scale_emb_t_3prong1pizeroDown","_CMS_scale_emb_t_3prong1pizeroUp","_CMS_scale_emb_m_etalt1p2Down","_CMS_scale_emb_m_etalt1p2Up","_CMS_scale_emb_m_eta1p2to2p1Down","_CMS_scale_emb_m_eta1p2to2p1Up","_CMS_eff_t_embedded_pt30to35Down","_CMS_eff_t_embedded_pt30to35Up","_CMS_eff_t_embedded_pt35to40Down","_CMS_eff_t_embedded_pt35to40Up","_CMS_eff_t_embedded_ptgt40Down","_CMS_eff_t_embedded_ptgt40Up","_CMS_eff_prong_embDown","_CMS_eff_prong_embUp","_CMS_eff_1prong1pizero_embDown","_CMS_eff_1prong1pizero_embUp","_CMS_eff_3prong1pizero_embDown","_CMS_eff_3prong1pizero_embUp","_CMS_singlemutrg_embDown","_CMS_singlemutrg_embUp","_CMS_mutautrg_embDown","_CMS_mutautrg_embUp"};
   ...
   for (Int_t i = 0; i < nentries_wtn; i++) {
	...
	//bool print = (evt==904610074 or evt==936567679 or evt==684938308 or evt==1716217044 or evt==111052062 or evt==826326770 or evt==128553000 or evt==1808562641 or evt==380956985);


	//if (print) cout<<evt<<" "<<pt_1<<" "<<pt_2<<" "<<eta_1<<" "<<eta_2<<endl;
...
//if (print) cout<<"e iso"<<endl;
	if (iso_1>0.15) continue;

//if (print) cout<<"met filters"<<endl;
...
//if (print) cout<<"btag"<<endl;
	...
	//recompute fractions //FIXME
        if (njets==0 && mymu.DeltaR(mytau)>3){
        ...
        else if (njets==0 && mymu.DeltaR(mytau)<=3){
	...
	if (mymu.Pt()<23) is_xtrg=true;
        double FF=1.0*get_ff(mytau.Pt(), mt, (mymu+mytau).M(), m_sv, mymu.Pt(), mymet.Pt(), njets, is_xtrg, frac_tt, frac_qcd, frac_w, ""); // Our FF
if (evt==342715925 or evt==347067821 or evt==272015187 or evt==278358229 or evt==320001756) cout<<evt<<" "<<FF<<" "<<frac_w<<" "<<frac_qcd<<" "<<frac_tt<<endl;
	...
	for (int k=0; k<nbhist; ++k){
	   ...
	   massJets=mjj;
	     ...
	     if (sample=="embedded"){
	        ...
	        if (k==25 && mymu.Pt()>23) weight2=0.98;
                else if (k==26 && mymu.Pt()>23) weight2=1.02;
                else if (k==27 && mymu.Pt()<=23) weight2=0.98*trg_ratio_down;
                else if (k==28 && mymu.Pt()<=23) weight2=1.02*trg_ratio_up;
	      }
	     }
	     else{
              if (k>0 && k<9 && gen_match_2==5){ // TES x 8
		...
		if (norecoil){
                   ...
                   else if (k==35){numberJets=njets_JERDown; massJets=mjj_JERDown; mymet.SetPtEtaPhiM(met_JERDown,0,metphi_JERDown,0); mtt=m_sv_JERDown;}
                   else if (k==36){numberJets=njets_JERUp; massJets=mjj_JERUp; mymet.SetPtEtaPhiM(met_JERUp,0,metphi_JERUp,0); mtt=m_sv_JERUp;}
		}
		else{
                   if (k==15){numberJets=njets_JetAbsoluteDown; massJets=mjj_JetAbsoluteDown; mymet.SetPtEtaPhiM(met_JetAbsoluteDown,0,metphi_JetAbsoluteDown,0); }
                   else if (k==16){numberJets=njets_JetAbsoluteUp; massJets=mjj_JetAbsoluteUp; mymet.SetPtEtaPhiM(met_JetAbsoluteUp,0,metphi_JetAbsoluteUp,0);}
                   else if (k==17){numberJets=njets_JetAbsoluteyearDown; massJets=mjj_JetAbsoluteyearDown; mymet.SetPtEtaPhiM(met_JetAbsoluteyearDown,0,metphi_JetAbsoluteyearDown,0); }
                   else if (k==18){numberJets=njets_JetAbsoluteyearUp; massJets=mjj_JetAbsoluteyearUp; mymet.SetPtEtaPhiM(met_JetAbsoluteyearUp,0,metphi_JetAbsoluteyearUp,0); }
                   else if (k==19){numberJets=njets_JetBBEC1Down; massJets=mjj_JetBBEC1Down; mymet.SetPtEtaPhiM(met_JetBBEC1Down,0,metphi_JetBBEC1Down,0); }
                   else if (k==20){numberJets=njets_JetBBEC1Up; massJets=mjj_JetBBEC1Up; mymet.SetPtEtaPhiM(met_JetBBEC1Up,0,metphi_JetBBEC1Up,0); }
                   else if (k==21){numberJets=njets_JetBBEC1yearDown; massJets=mjj_JetBBEC1yearDown; mymet.SetPtEtaPhiM(met_JetBBEC1yearDown,0,metphi_JetBBEC1yearDown,0); }
                   else if (k==22){numberJets=njets_JetBBEC1yearUp; massJets=mjj_JetBBEC1yearUp; mymet.SetPtEtaPhiM(met_JetBBEC1yearUp,0,metphi_JetBBEC1yearUp,0); }
                   else if (k==23){numberJets=njets_JetEC2Down; massJets=mjj_JetEC2Down; mymet.SetPtEtaPhiM(met_JetEC2Down,0,metphi_JetEC2Down,0); }
                   else if (k==24){numberJets=njets_JetEC2Up; massJets=mjj_JetEC2Up; mymet.SetPtEtaPhiM(met_JetEC2Up,0,metphi_JetEC2Up,0); }               
                   else if (k==25){numberJets=njets_JetEC2yearDown; massJets=mjj_JetEC2yearDown; mymet.SetPtEtaPhiM(met_JetEC2yearDown,0,metphi_JetEC2yearDown,0); }
                   else if (k==26){numberJets=njets_JetEC2yearUp; massJets=mjj_JetEC2yearUp; mymet.SetPtEtaPhiM(met_JetEC2yearUp,0,metphi_JetEC2yearUp,0);}
                   else if (k==27){numberJets=njets_JetFlavorQCDDown; massJets=mjj_JetFlavorQCDDown; mymet.SetPtEtaPhiM(met_JetFlavorQCDDown,0,metphi_JetFlavorQCDDown,0); }
                   else if (k==28){numberJets=njets_JetFlavorQCDUp; massJets=mjj_JetFlavorQCDUp; mymet.SetPtEtaPhiM(met_JetFlavorQCDUp,0,metphi_JetFlavorQCDUp,0); }
                   else if (k==29){numberJets=njets_JetHFDown; massJets=mjj_JetHFDown; mymet.SetPtEtaPhiM(met_JetHFDown,0,metphi_JetHFDown,0); }          
                   else if (k==30){numberJets=njets_JetHFUp; massJets=mjj_JetHFUp; mymet.SetPtEtaPhiM(met_JetHFUp,0,metphi_JetHFUp,0); }
                   else if (k==31){numberJets=njets_JetHFyearDown; massJets=mjj_JetHFyearDown; mymet.SetPtEtaPhiM(met_JetHFyearDown,0,metphi_JetHFyearDown,0);}
                   else if (k==32){numberJets=njets_JetHFyearUp; massJets=mjj_JetHFyearUp; mymet.SetPtEtaPhiM(met_JetHFyearUp,0,metphi_JetHFyearUp,0); }
                   else if (k==33){numberJets=njets_JetRelativeBalDown; massJets=mjj_JetRelativeBalDown; mymet.SetPtEtaPhiM(met_JetRelativeBalDown,0,metphi_JetRelativeBalDown,0); }
                   else if (k==34){numberJets=njets_JetRelativeBalUp; massJets=mjj_JetRelativeBalUp; mymet.SetPtEtaPhiM(met_JetRelativeBalUp,0,metphi_JetRelativeBalUp,0); }
                   else if (k==35){numberJets=njets_JERDown; massJets=mjj_JERDown; mymet.SetPtEtaPhiM(met_JERDown,0,metphi_JERDown,0); }
                   else if (k==36){numberJets=njets_JERUp; massJets=mjj_JERUp; mymet.SetPtEtaPhiM(met_JERUp,0,metphi_JERUp,0); }
                }
              }
		...
		if (k==63) {weight2=prefiring_weight_down/(prefiring_weight+0.00000001);}
              ...
              if (k>64 && k<81){
                ...
                else if (k==75 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=0.90;}
                else if (k==76 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=30 && mytau.Pt()<40) {weight2=1.10;}
                else if (k==77 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=0.90;}
                else if (k==78 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=40 && mytau.Pt()<50) {weight2=1.10;}
                else if (k==79 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=50) {weight2=0.90;}
                else if (k==80 && (gen_match_2==2 or gen_match_2==4) && mytau.Pt()>=50) {weight2=1.10;}
              }
              ...
              else if (is_ggh && k>88 && k<107){ // WG1 x 18
                if (k==89) weight2=1+WG1unc[0];
                else if (k==90) weight2=1-WG1unc[0];
                else if (k==91) weight2=1+WG1unc[1];
                else if (k==92) weight2=1-WG1unc[1];
                else if (k==93) weight2=1+WG1unc[2];
                else if (k==94) weight2=1-WG1unc[2];
                else if (k==95) weight2=1+WG1unc[3];
                else if (k==96) weight2=1-WG1unc[3];
                else if (k==97) weight2=1+WG1unc[4];
                else if (k==98) weight2=1-WG1unc[4];
                else if (k==99) weight2=1+WG1unc[5];
                else if (k==100) weight2=1-WG1unc[5];
                else if (k==101) weight2=1+WG1unc[6];
                else if (k==102) weight2=1-WG1unc[6];
                else if (k==103) weight2=1+WG1unc[7];
                else if (k==104) weight2=1-WG1unc[7];
                else if (k==105) weight2=1+WG1unc[8];
                else if (k==106) weight2=1-WG1unc[8];
             }
              else if (is_qqh && k>88 && k<109){ // WG1 x 20
                if (k==89) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==90) weight2=vbf_uncert_stage_1_1(0, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==91) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==92) weight2=vbf_uncert_stage_1_1(1, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==93) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==94) weight2=vbf_uncert_stage_1_1(2, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==95) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==96) weight2=vbf_uncert_stage_1_1(3, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==97) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==98) weight2=vbf_uncert_stage_1_1(4, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==99) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==100) weight2=vbf_uncert_stage_1_1(5, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==101) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==102) weight2=vbf_uncert_stage_1_1(6, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==103) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==104) weight2=vbf_uncert_stage_1_1(7, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==105) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==106) weight2=vbf_uncert_stage_1_1(8, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
                else if (k==107) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), 1.0);
                else if (k==108) weight2=vbf_uncert_stage_1_1(9, int(Rivet_stage1_1_fine_cat_pTjet30GeV), -1.0);
              }
           ...
           if (name=="ST" or name=="VV" or name=="DY" or name=="Z" or name=="TT"){
              if (k>88 && k<131){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawmupt, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1-88]);
              }
           }
           if (sample=="data_obs"){
              if (k>0 && k<47){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawmupt, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-1]);
              }
           }
           if (sample=="embedded"){
              if (k>28 && k<75){ // FF 
                FF=1.0*get_ff(rawtaupt, rawmt, rawmvis, m_sv, rawmupt, mymet.Pt(), rawnjets, is_xtrg, frac_tt, frac_qcd, frac_w,FFsys[k-28-1]);
              }
           }

//if (print && k==0) cout<<"retrigger"<<endl;
...
//if (print && k==0) cout<<"tau pt"<<endl;
           if (mytau.Pt()<30) continue;

    	   mt=TMass_F(mymu.Pt(),mymet.Pt(),mymu.Px(),mymet.Px(),mymu.Py(),mymet.Py());
//if (print && k==0) cout<<mt<<" "<<mymu.Pt()<<" "<<mymet.Pt()<<" "<<mymu.Px()<<" "<<mymet.Px()<<" "<<mymu.Py()<<" "<<mymet.Py()<<endl;
	   myvar=mtt;
	   ...
	   float myvar2=massJets;
           ...
           if (do_differential){
              myvar0=(mymu+mytau+mymet).Pt();
              myvar1=(mymu+mytau+mymet).Pt();
              myvar2=(mymu+mytau+mymet).Pt();
              myvar3=(mymu+mytau+mymet).Pt();
              myvar4=(mymu+mytau+mymet).Pt();
              myvar5=(mymu+mytau+mymet).Pt();
              myvar6=massJets;
              myvar7=(mymu+mytau+mymet).Pt();
              myvar8=(mymu+mytau+mymet).Pt();
           }
	   ...
	   if (do_control_plots>0){
		myvar0=1;myvar1=1;myvar2=1;myvar3=1;myvar4=1;myvar5=1;myvar6=1;myvar7=1;myvar8=1;
	      ...
	      if (numberJets<2) mass7=-10;
           ...
           if (!do_differential && do_control_plots==0 && numberJets==0 && mt<50) category_0=true;
           ...
           if (do_differential && numberJets==0 && mt<50) category_0=true;
           ...
           if (do_differential && numberJets==1 && mt<50) category_1=true;
           ...
           if (do_differential && numberJets==2 && massJets<450 && mt<50) category_2=true;
           ...
           if (do_differential && numberJets==2 && massJets>=450 && mt<50) category_3=true;
           ...
           if (do_differential && numberJets>=3 && massJets<450 && mt<50) category_4=true;
...
//if (print && k==0) cout<<"category: "<<numberJets<<" "<<mt<<endl;
           ...
           if (do_differential && numberJets>=3 && massJets>=450 && mt<50) category_5=true;
           if (category_5 && q_1*q_2<0){
/*	       if (k==0 && signalRegion){
if (print && k==0) cout<<"fill"<<endl;
	 list_boosted1<<run<<" "<<lumi<<" "<<evt<<endl;
	       }*/
               if (k==0 && is_includedInEmbedded && signalRegion)
           ...
           if (do_differential && numberJets>=2 && mt<50) category_6=true;
           ...
           if (do_differential && mt<50) category_7=true;
           ...
           if (do_differential && mt<50) category_8=true;
           if (category_8 && q_1*q_2<0){
               ...
               if (k==0){ // fractions
                  if ((sample=="data_obs" or (sample=="embedded" or isT or isL)) && antiisoRegion)
                      f8real->Fill(myvar,aweight*weight2);
                  if ((sample!="data_obs" && sample!="embedded" && gen_match_2==6) && antiisoRegion)
                      f8jet->Fill(myvar,aweight*weight2);
               }
           }
    ...
    for (int k=0; k<nbhist; ++k){
       ...
       else if ((name=="ST" or name=="VV" or name=="DY" or name=="Z" or name=="TT") and k>88) postfix=postfixFF[k-88];
       else if (is_ggh and k>88) postfix=postfixGGH[k-88];
       else if (is_qqh and k>88) postfix=postfixVBF[k-88];
    ...
    TDirectory *OS3jet =fout->mkdir("mt_0jet_PTH_0_10");
    OS3jet->cd();
...
if (k>48 && k<51) cout<<h3ell_OS[k]->Integral()<<" "<<postfix<<endl;
    ...
    TDirectory *OS4jet =fout->mkdir("mt_0jet_PTH_GE10");
    OS4jet->cd();
cout<<h4tau_OS[0]->Integral()<<endl;
    ...
    TDirectory *OS5jet =fout->mkdir("mt_boosted_1J");
    OS5jet->cd();
    ...
    TDirectory *OS6jet =fout->mkdir("mt_boosted_GE2J");
    OS6jet->cd();
    ...
    TDirectory *OS7jet =fout->mkdir("mt_vbf_PTH_0_200");
    OS7jet->cd();
    ...
    TDirectory *OS8jet =fout->mkdir("mt_vbf_PTH_GE_200");
    OS8jet->cd();
