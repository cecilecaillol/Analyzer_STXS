...
TF1* lptclosure_w_1jet=(TF1*) fmvisclosure.Get("closure_lpt_mt_1jet_w");
TF1* lptclosure_qcd_1jet=(TF1*) fmvisclosure.Get("closure_lpt_mt_1jet_qcd");
TF1* lptclosure_tt=(TF1*) fmvisclosure.Get("closure_lpt_mt_ttmc");
TF1* lptclosure_w_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_mt_w");
TF1* lptclosure_w_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_mt_w");
TF1* lptclosure_w_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_mt_w");
TF1* lptclosure_qcd_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_mt_qcd");
TF1* lptclosure_qcd_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_mt_qcd");
TF1* lptclosure_qcd_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_mt_qcd");
TF1* lptclosure_tt_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_mt_ttmc");
TF1* lptclosure_tt_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_mt_ttmc");
TF1* lptclosure_tt_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_mt_ttmc");
TF1* lptclosure_w_xtrg_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_xtrg_mt_w");
TF1* lptclosure_w_xtrg_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_xtrg_mt_w");
TF1* lptclosure_w_xtrg_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_xtrg_mt_w");
TF1* lptclosure_qcd_xtrg_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_xtrg_mt_qcd");
TF1* lptclosure_qcd_xtrg_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_xtrg_mt_qcd");
TF1* lptclosure_qcd_xtrg_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_xtrg_mt_qcd");
TF1* lptclosure_tt_xtrg_taupt30to40=(TF1*) fmvisclosure.Get("closure_lpt_taupt30to40_xtrg_mt_ttmc");
TF1* lptclosure_tt_xtrg_taupt40to50=(TF1*) fmvisclosure.Get("closure_lpt_taupt40to50_xtrg_mt_ttmc");
TF1* lptclosure_tt_xtrg_tauptgt50=(TF1*) fmvisclosure.Get("closure_lpt_tauptgt50_xtrg_mt_ttmc");
...
float get_ff(float pt, float mt, float mvis, float msv, float lpt, float met, int njets, bool xtrg, float frac_tt, float frac_qcd, float frac_w, TString shift){
   ...
   if (xtrg){
     ...
     if (pt<40){
      if (shift=="lptclosure_qcd_up") ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_taupt30to40)*get_lpt_closure(lpt, lptclosure_qcd_taupt30to40);
      else if (shift=="lptclosure_qcd_down") ff_qcd = ff_qcd;
      else ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_taupt30to40);
      if (shift=="lptclosure_w_up") ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_taupt30to40)*get_lpt_closure(lpt, lptclosure_w_taupt30to40);
      else if (shift=="lptclosure_w_down") ff_w = ff_w;
      else ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_taupt30to40);
      if (shift=="lptclosure_tt_up") ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_taupt30to40)*get_lpt_closure(lpt, lptclosure_tt_taupt30to40);
      else if (shift=="lptclosure_tt_down") ff_tt = ff_tt;
      else ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_taupt30to40);
     }
     else if (pt<50){
      if (shift=="lptclosure_qcd_up") ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_taupt40to50)*get_lpt_closure(lpt, lptclosure_qcd_taupt40to50);
      else if (shift=="lptclosure_qcd_down") ff_qcd = ff_qcd;
      else ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_taupt40to50);
      if (shift=="lptclosure_w_up") ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_taupt40to50)*get_lpt_closure(lpt, lptclosure_w_taupt40to50);
      else if (shift=="lptclosure_w_down") ff_w = ff_w;
      else ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_taupt40to50);
      if (shift=="lptclosure_tt_up") ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_taupt40to50)*get_lpt_closure(lpt, lptclosure_tt_taupt40to50);
      else if (shift=="lptclosure_tt_down") ff_tt = ff_tt;
      else ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_taupt40to50);
     }
     else {
      if (shift=="lptclosure_qcd_up") ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_tauptgt50)*get_lpt_closure(lpt, lptclosure_qcd_tauptgt50);
      else if (shift=="lptclosure_qcd_down") ff_qcd = ff_qcd;
      else ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_tauptgt50);
      if (shift=="lptclosure_w_up") ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_tauptgt50)*get_lpt_closure(lpt, lptclosure_w_tauptgt50);
      else if (shift=="lptclosure_w_down") ff_w = ff_w;
      else ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_tauptgt50);
      if (shift=="lptclosure_tt_up") ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_tauptgt50)*get_lpt_closure(lpt, lptclosure_tt_tauptgt50);
      else if (shift=="lptclosure_tt_down") ff_tt = ff_tt;
      else ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt_tauptgt50);
     }
     /*else if (njets==1){
      if (shift=="lptclosure_qcd_up") ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_1jet)*get_lpt_closure(lpt, lptclosure_qcd_1jet);
      else if (shift=="lptclosure_qcd_down") ff_qcd = ff_qcd;
      else ff_qcd = ff_qcd*get_lpt_closure(lpt, lptclosure_qcd_1jet);
      if (shift=="lptclosure_w_up") ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_1jet)*get_lpt_closure(lpt, lptclosure_w_1jet);
      else if (shift=="lptclosure_w_down") ff_w = ff_w;
      else ff_w = ff_w*get_lpt_closure(lpt, lptclosure_w_1jet);
      if (shift=="lptclosure_tt_up") ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt)*get_lpt_closure(lpt, lptclosure_tt);
      else if (shift=="lptclosure_tt_down") ff_tt = ff_tt;
      else ff_tt = ff_tt*get_lpt_closure(lpt, lptclosure_tt);
     }*/
   }
