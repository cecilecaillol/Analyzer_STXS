...
if __name__ == "__main__":
    ...
    for k1 in dirList:
         h1 = k1.ReadObj()
         if "msv" not in h1.GetName() and "mvis" not in h1.GetName():
           ...
           for k2 in dirList2:
              ...
              for j in range(0,h3.GetSize()-2):
                 h3.SetBinError(j+1,((0.01*0.01*h3.GetBinContent(j+1)*h3.GetBinContent(j+1))+h3.GetBinError(j+1)*h3.GetBinError(j+1))**0.5)
